    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            ...
            // обработка нажатий клавиш
                ...
                case (sf::Keyboard::Num3): decColor(1); break;
                case (sf::Keyboard::Num4): incColor(1); break;
                case (sf::Keyboard::Num5): decColor(2); break;
                case (sf::Keyboard::Num6): incColor(2); break;
                default: break;
                }
            }
        }
